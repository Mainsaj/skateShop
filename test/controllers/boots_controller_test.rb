...
class BootsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boot" do
    assert_difference('Boot.count') do
      post boots_url, params: { boot: { brand: @boot.brand, cost: @boot.cost, model: @boot.model } }
    end
  ...
  test "should update boot" do
    patch boot_url(@boot), params: { boot: { brand: @boot.brand, cost: @boot.cost, model: @boot.model } }
