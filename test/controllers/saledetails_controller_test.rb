...
class SaledetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saledetail" do
    assert_difference('Saledetail.count') do
      post saledetails_url, params: { saledetail: { cost: @saledetail.cost, prodqty: @saledetail.prodqty, product_id: @saledetail.product_id, sail_id: @saledetail.sail_id } }
    end
  ...
  test "should update saledetail" do
    patch saledetail_url(@saledetail), params: { saledetail: { cost: @saledetail.cost, prodqty: @saledetail.prodqty, product_id: @saledetail.product_id, sail_id: @saledetail.sail_id } }
